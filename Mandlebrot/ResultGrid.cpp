#include "ResultGrid.h"
	...
	template<class resultType, class calculator> ResultGrid<resultType, calculator>::ResultGrid(Grid<double> grid, calculator calc)
	{
	...
	template<class resultType, class calculator> resultType ResultGrid<resultType, calculator>::Point(int i, int j)
	{
		if (i < 0 || i >= XPoints)
		{
